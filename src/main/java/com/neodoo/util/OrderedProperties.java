...
/**
 * The <code>OrderedProperties</code> class represents a persistent set of properties.
 * The <code>OrderedProperties</code> can be saved to a stream or loaded from a stream.
 ...
 * <p>
 * Please note, this class is an adaptation from the java.util.Properties class.
 * The primary difference is that instead of inheriting from Hashtable, this class
 * inherits from LinkedHashMap in order to maintain an ordered set of properties.
 * <p>
 *
 * @author RSavage
 * @since 1.3
...
public class OrderedProperties extends LinkedHashMap<String, String>
{
	 ...
	 */
	private static final long serialVersionUID = 5492474579485532196L;
   ...
   private static boolean includeDateHeader = true;
	...
	private void store0(BufferedWriter bw, String comments, boolean escUnicode)
		...
		synchronized (this) {
			...
			for (Object itemKey : set) {
				String key = itemKey.toString();
				String val = (String) get(itemKey);
	...
	public static void setIncludeDateHeader(boolean include) {
      includeDateHeader = include;
   }

   public static boolean isIncludeDateHeader() {
