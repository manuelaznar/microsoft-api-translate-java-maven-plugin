...
public class LocalizeMojo extends AbstractMojo {
   ...
   private String getSmartSyncFileName(File file) {
            ...
            for (String destLanguage : languages) {
                ...
                try {
                    for(String msgKey : keys) {
                        ...
                        {
                            // perform translation
                            EventProcessor e = new EventProcessor(apiKey, debug, sourceLanguage, destLanguage, msgKey, outputProperties);
                            parse(new ByteArrayInputStream(msgVal.getBytes(sourceFileEncoding)), e);
                        }
                    }
    ...
    public void setDestinationFileEncoding(String destinationFileEncoding) {
        this.destinationFileEncoding = destinationFileEncoding;
    }

    public void setDestinationFileEncodingIncludeBOM(Boolean destinationFileEncodingIncludeBOM) {
        this.destinationFileEncodingIncludeBOM = destinationFileEncodingIncludeBOM;
    }
    ...
    public void setLanguageFilePattern(String languageFilePattern) {
        this.languageFilePattern = languageFilePattern;
    }

    public void setLanguageFilePatterns(String[] languageFilePatterns) {
        this.languageFilePatterns = languageFilePatterns;
    }
    ...
    public void setPassThruProperties(String[] passThruProperties) {
        this.passThruProperties = passThruProperties;
    }
    ...
    public void setSmartSync(Boolean smartSync) {
        this.smartSync = smartSync;
    }

    public void setSmartSyncChangeFile(String smartSyncChangeFile) {
        this.smartSyncChangeFile = smartSyncChangeFile;
    }
    ...
    public void setSourceTranslationFile(String sourceTranslationFile) {
        this.sourceTranslationFile = sourceTranslationFile;
    }

    public void setSourceTranslationFiles(String[] sourceTranslationFiles) {
        this.sourceTranslationFiles = sourceTranslationFiles;
    }

    public void setSourceTranslationPath(File sourceTranslationPath) {
        this.sourceTranslationPath = sourceTranslationPath;
    }
